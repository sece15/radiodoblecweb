...
export const STORE_PRODUCTS: Product[] = [
  ...
  },
  {
    ...
    rotation: 2,
    description: "¡CORTE OVERSIZE Y ESTILO URBANO DE RADIO DOBLE C! Camisa de algodón pesado premium con botones reforzados y tipografía fanzine de autor. Diseñada para cabina de radio, eventos en vivo y el uso diario con máxima soltura y frescura.",
    colors: ["NEGRA ESTUDIO", "VARIANTE ALTERNATIVA"],
    sizes: ["S", "M", "L", "XL"],
    variantImages: {
      "NEGRA ESTUDIO": "/store/camisadoblec.png",
      "VARIANTE ALTERNATIVA": "/store/camisadoblec-1.png",
    },
  ...
  {
    id: "3",
    name: "CAMISA DOBLE C CON BOLSILLO TÉCNICO",
    price: "S/59.90",
    imageUrl: "/store/camisadoblec-bolsillo.png",
    rotation: -1,
    description: "¡DISEÑO UTILITARIO CON BOLSILLO FRONTAL REFORZADO! Camisa técnica de corte moderno con bolsillo frontal para accesorios de estudio, credenciales o grabadora portátil. Confeccionada en tela resistente de secado rápido con parche distintivo de Radio Doble C.",
    colors: ["BOLSILLO FRONTAL", "DETALLE LATERAL"],
    sizes: ["S", "M", "L", "XL"],
    variantImages: {
      "BOLSILLO FRONTAL": "/store/camisadoblec-bolsillo.png",
      "DETALLE LATERAL": "/store/camisadoblec-bolsillo-2.png",
    },
    badge: "🌟 NUEVO INGRESO",
  },
  {
