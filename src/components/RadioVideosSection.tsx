...
const UPCOMING_VIDEOS: RadioVideoItem[] = [
  ...
  {
    id: "video_l_mental_1",
    title: "L-Mental: Misterio, Análisis Psicológico & La Zona Esotérica de La Seka",
    host: "La Seka",
    category: "PODCAST",
    durationText: "42:15",
    imageUrl: "/lmental.jpg",
    description: "Exploración de casos intrigantes, la mente detrás de cada historia y la lectura de cartas en vivo con La Seka acompañado de clásicos de Rock, Reggae y Ska.",
    tags: ["Misterio", "Psicología", "Zona Esotérica", "Rock & Ska"],
    status: "PRÓXIMAMENTE",
    releaseEstimate: "Próximo Viernes",
  },
  {
