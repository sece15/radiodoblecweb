...
const UPCOMING_VIDEOS: RadioVideoItem[] = [
  ...
  {
    id: "video_koyote_1",
    title: "Live Sessions Doble C: Acústicos & Charlas sin Filtro",
    host: "El Koyote",
    ...
    description: "Sesión íntima en video grabada en los estudios de Radio Doble C. Música acústica en vivo, anécdotas de gira y pedidos directos del público.",
    tags: ["Acústico", "En Vivo", "Cabina"],
    status: "EN PRODUCCIÓN",
    releaseEstimate: "Fin de Mes",
  },
  {
    id: "video_beats_1",
